...
from collective.twitter.search.portlet import twsearch
...
class PortletTest(unittest.TestCase):
    ...
    def test_portlet_type_registered(self):
        portlet = getUtility(
            IPortletType,
            name='collective.twitter.search.TwitterSearchPortlet')
        self.assertEquals(portlet.addview,
                          'collective.twitter.search.TwitterSearchPortlet')
